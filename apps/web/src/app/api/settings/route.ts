...
function serializePublicSettings(settings: Awaited<ReturnType<typeof getSettings>>) {
  return {
    ...
    qrScanEnabled: settings.qrScanEnabled,
    qrScanTitle: settings.qrScanTitle,
    qrScanBody: settings.qrScanBody,
    ...
    settings = await prisma.settings.update({
      ...
      data: {
        ...definedSettingsFields({
          ...
          qrScanEnabled: data.qrScanEnabled,
          qrScanTitle: data.qrScanTitle,
          qrScanBody: data.qrScanBody,
